 ...
 * @since 25/05/2023
 * @see https://brunapr.github.io/computacao-grafica/Rotor/index.html
 */
...
var armMatrix = new Matrix4()
  .setTranslate(0, 0, 2.5)
  .translate(0, 0, 0)
  .rotate(joint.arm, 0, 0, 1)
  .translate(0, 0, 0);

/**  @type {Matrix4} */
var handMatrix = new Matrix4()
  .setTranslate(0, 0, 0)
  .rotate(joint.hand, 1, 0, 0);
...
var shoulderMatrixLocal = new Matrix4().setScale(4, 2, 4);
var armMatrixLocal = new Matrix4().setScale(15, 1, 0.5);
